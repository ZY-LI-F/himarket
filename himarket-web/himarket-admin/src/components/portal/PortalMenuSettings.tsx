...
export function PortalMenuSettings({ portal, onRefresh }: PortalMenuSettingsProps) {
  ...
  return (
    <div className="p-6 text-claude-neutral-900">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold mb-2">菜单管理</h1>
        <p className="text-claude-neutral-600">配置导航菜单</p>
      </div>

      <div className="mb-4">
        <h3 className="text-sm font-semibold text-claude-neutral-700 mb-4">导航菜单项</h3>
            ...
            return (
              <div
                ...
                className={`
                  ...
                  hover:border-claude-brand-primary/40
                  ${enabled ? 'border-claude-brand-primary/40 bg-claude-brand-surfaceTint/70' : 'border-claude-neutral-200 bg-claude-neutral-50'}
                `}
              >
                <span className="text-base text-claude-neutral-600 flex-shrink-0">{item.icon}</span>
                <div className="min-w-0 flex-1">
                  <div className="font-semibold text-claude-neutral-900 text-sm truncate">{item.label}</div>
                  <div className="text-xs text-claude-neutral-500 truncate">{item.description}</div>
                </div>
                <Switch
                  size="small"
                  checked={enabled}
      ...
      <div className="mt-6 rounded-claude-md border border-claude-neutral-200 bg-claude-neutral-50 p-4">
        <div className="text-sm text-claude-neutral-600">
